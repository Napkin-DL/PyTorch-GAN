...
class decode_Generator(nn.Module):
    ...
    def forward(self, x, encode_out1, encode_out2, encode_out3):
        ...
        decode_out2 = self.decode_resblocks2(decode_out1+encode_out2)
        decode_out3 = self.decode_resblocks3(decode_out2+encode_out1)
...
for epoch in range(opt.n_epochs):
    for i, ((imgs_A, labels_A), (imgs_B, labels_B)) in enumerate(zip(dataloader_A, dataloader_B)):
        ...
        imgs_A_x, encode_1, encode_2, encode_fake_B = source_encode_generator(imgs_A, z)
        decode_fake_B = decode_generator(imgs_A_x, encode_1, encode_2, encode_fake_B)
        ...
        imgs_B_x, encode_1, encode_2, encode_real_B = target_encode_generator(imgs_B, z)
        decode_fake_B = decode_generator(imgs_B_x, encode_1, encode_2, encode_fake_B)
