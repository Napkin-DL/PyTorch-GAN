...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_features=64, out_features=64):
        ...
        self.encode_block = nn.Sequential(
            ...
            nn.Conv2d(in_channels=2*in_features,out_channels=4*in_features,kernel_size=(3, 3),stride=(2, 2),padding=0),
        ...
        self.decode_block = nn.Sequential(
            nn.ConvTranspose2d(in_channels=4*in_features,out_channels=2*in_features,kernel_size=(3, 3),stride=(2, 2), padding=0),
            nn.BatchNorm2d(2*in_features),
            nn.LeakyReLU(inplace=True),
