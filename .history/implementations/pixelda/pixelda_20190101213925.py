...
# Optimizers
target_encode_optimizer_G = torch.optim.Adam(target_encode_generator.parameters(),
                                lr=opt.lr, betas=(opt.b1, opt.b2))
source_encode_optimizer_G = torch.optim.Adam((source_encode_generator.parameters(),
                                lr=opt.lr, betas=(opt.b1, opt.b2))
