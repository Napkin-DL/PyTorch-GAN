...
# Optimizers
target_encode_optimizer_G = torch.optim.Adam( itertools.chain(target_encode_generator.parameters(), encode_classifier.parameters()),
                                lr=opt.lr, betas=(opt.b1, opt.b2))
source_encode_optimizer_G = torch.optim.Adam( itertools.chain(source_encode_generator.parameters(), encode_classifier.parameters()),
                                lr=opt.lr, betas=(opt.b1, opt.b2))
