...
for epoch in range(opt.n_epochs):
    for i, ((imgs_A, labels_A), (imgs_B, labels_B)) in enumerate(zip(dataloader_A, dataloader_B)):
        ...
        encode_real_loss = encode_adversarial_loss(encode_discriminator(encode_real_B), valid)
        encode_fake_loss = encode_adversarial_loss(encode_discriminator(encode_fake_B.detach()), fake)
